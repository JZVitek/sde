...
import { encryptText, decryptText, generateDailyPassword } from '@/lib/encryption';
  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-8">
      <Card className="max-w-4xl mx-auto backdrop-blur-lg bg-opacity-80 border-primary/20">
        <CardHeader>
          <CardTitle className="text-2xl font-bold text-center">Sistema de Encriptación</CardTitle>
        </CardHeader>
        <CardContent>
